            ...
            return (
              ...
              >
                ...
                >
                  {/* Front of card */}
                  <div 
                    className="absolute inset-0 border-2 border-foreground/20 hover:border-primary transition-all overflow-hidden group"
                  ...
                  >
                    ...
                    <div className="p-6 bg-card">
                      ...
                      <p className="text-xs text-primary uppercase tracking-wide">Click to flip</p>
                    </div>
                  </div>

                  {/* Back of card */}
                  <div 
                    className="absolute inset-0 border-2 border-primary bg-card p-6 flex flex-col justify-center"
                    style={{ 
                      backfaceVisibility: "hidden",
                      transform: "rotateY(180deg)"
                    }}
                  >
                    <h3 className="text-xl font-serif font-bold mb-4 uppercase text-primary">{project.title}</h3>
                    
                    <div className="flex flex-wrap gap-2 mb-6 pb-4 border-b border-foreground/20">
